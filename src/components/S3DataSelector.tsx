...
const S3DataSelector = ({
    ...
    s3Object: any, setS3Object: any, s3Bucket: any,
    setS3Bucket: any, setShowCredsExpiredAlert: any, showCredsExpiredAlert: any
}) => {
    const [bucketStatus, setBucketStatus] = useState<DropdownStatusProps.StatusType>("pending");
    const [geojsonStatus, setGeojsonStatus] = useState<DropdownStatusProps.StatusType>("pending");
