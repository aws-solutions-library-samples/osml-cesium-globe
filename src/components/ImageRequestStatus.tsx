...
const ImageRequestStatus = ({
    ...
    let validImageRequestSatusValues = new Map<string, string>;
        ...
        return (
            <div>
                <div style={{
                    ...
                    <StatusIndicator
                        type={imageRequestStatus.state}>{validImageRequestSatusValues.get(imageRequestStatus.state)}</StatusIndicator>
                </div>
            </div>
        )
    } else {
