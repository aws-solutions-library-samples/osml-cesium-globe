...
const NewRequestModal = ({
  ...
  const [featureSelectionAlgorithm, setFeatureSelectionAlgorithm] =
      useState(DEFAULT_FEATURE_SELECTION_ALGORITHM);
  const [featureSelectionIouThreshold, setFeatureSelectionIouThreshold] =
      useState(DEFAULT_FEATURE_SELECTION_IOU_THRESHOLD);
  const [featureSelectionSkipBoxThreshold, setFeatureSelectionSkipBoxThreshold] =
              ...
              >
                <Container>
                  <SpaceBetween direction="vertical" size="l">
                    ...
                    <ExpandableSection headerText="Feature Selection Options">
                      <FormField label="Feature Selection Algorithm">
                        <Autosuggest
                            onChange={({detail}) => setFeatureSelectionAlgorithm(detail.value)}
                            value={featureSelectionAlgorithm}
                            options={[
                              {value: "NONE"},
                              {value: "NMS"},
                              {value: "SOFT_NMS"},
