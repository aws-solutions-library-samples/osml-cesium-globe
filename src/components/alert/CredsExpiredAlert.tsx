...
const startingAlertMessage = "Refresh your credentials before closing this alert."
    ...
    const updateAlert = async () => {
        try {
            ...
            if (e.name === 'ExpiredToken') {
                setAlertMessage("AWS token still is expired. Refresh credentials and try again.")
            } else {
                // Something else went wrong
                setAlertMessage("Uknown error occurred when testing credentials. Restart application.")
            }
        }
    };
    return (
